...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/s3manager-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/s3manager-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `s3manager` available on your platform:
...
```
pixi search s3manager --channel conda-forge
```
